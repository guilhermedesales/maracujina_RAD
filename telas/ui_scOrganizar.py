...
"")
        ...
        self.label.setStyleSheet("font: 12pt \"Helvetica\";\n"
"border: none;")
        self.label.setObjectName("label")
        self.label_6 = QtWidgets.QLabel(parent=self.frame_9)
        self.label_6.setGeometry(QtCore.QRect(10, 60, 141, 31))
        self.label_6.setStyleSheet("font: 12pt \"Helvetica\";\n"
"border: none;")
        self.label_6.setObjectName("label_6")
        self.label_7 = QtWidgets.QLabel(parent=self.frame_9)
        self.label_7.setGeometry(QtCore.QRect(10, 100, 141, 31))
        self.label_7.setStyleSheet("font: 12pt \"Helvetica\";\n"
"border: none;")
...
"")
        ...
        self.lblTask = QtWidgets.QLabel(parent=self.frame_9)
        self.lblTask.setGeometry(QtCore.QRect(120, 20, 71, 31))
        self.lblTask.setStyleSheet("font: 12pt \"Helvetica\";\n"
"border: none;")
        self.lblTask.setObjectName("lblTask")
        self.lblTaskPen = QtWidgets.QLabel(parent=self.frame_9)
        self.lblTaskPen.setGeometry(QtCore.QRect(150, 60, 41, 31))
        self.lblTaskPen.setStyleSheet("font: 12pt \"Helvetica\";\n"
"border: none;\n"
"color:rgb(223, 121, 121)")
        self.lblTaskPen.setObjectName("lblTaskPen")
        self.lblTaskCom = QtWidgets.QLabel(parent=self.frame_9)
        self.lblTaskCom.setGeometry(QtCore.QRect(150, 100, 41, 31))
        self.lblTaskCom.setStyleSheet("font: 12pt \"Helvetica\";\n"
"border: none;\n"
"color: rgb(77, 190, 46)")
        self.lblTaskCom.setObjectName("lblTaskCom")
        ...
        self.containerTarefas.setFrameShape(QtWidgets.QFrame.Shape.NoFrame)
        self.containerTarefas.setFrameShadow(QtWidgets.QFrame.Shadow.Raised)
        self.containerTarefas.setObjectName("containerTarefas")
        self.verticalLayout_11 = QtWidgets.QVBoxLayout(self.containerTarefas)
        self.verticalLayout_11.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_11.setSpacing(0)
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.addTask = QtWidgets.QWidget(parent=self.containerTarefas)
        self.addTask.setMinimumSize(QtCore.QSize(0, 100))
        self.addTask.setMaximumSize(QtCore.QSize(16777215, 100))
        self.addTask.setObjectName("addTask")
        self.horizontalLayout_5 = QtWidgets.QHBoxLayout(self.addTask)
        self.horizontalLayout_5.setObjectName("horizontalLayout_5")
        self.verticalLayout_11.addWidget(self.addTask)
        self.scrollArea = QtWidgets.QScrollArea(parent=self.containerTarefas)
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scroll = QtWidgets.QWidget()
        self.scroll.setGeometry(QtCore.QRect(0, 0, 708, 438))
        self.scroll.setObjectName("scroll")
        self.verticalLayout_12 = QtWidgets.QVBoxLayout(self.scroll)
        self.verticalLayout_12.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_12.setSpacing(0)
        self.verticalLayout_12.setObjectName("verticalLayout_12")
        self.Tarefas = QtWidgets.QWidget(parent=self.scroll)
        self.Tarefas.setObjectName("Tarefas")
        self.verticalLayout_13 = QtWidgets.QVBoxLayout(self.Tarefas)
        self.verticalLayout_13.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_13.setSpacing(0)
        self.verticalLayout_13.setObjectName("verticalLayout_13")
        self.verticalLayout_12.addWidget(self.Tarefas)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Tarefas Totais:"))
        self.label_6.setText(_translate("MainWindow", "Tarefas Pendentes:"))
        self.label_7.setText(_translate("MainWindow", "Tarefas Completas:"))
        self.btnCriarLista.setText(_translate("MainWindow", "+"))
        self.label_8.setText(_translate("MainWindow", "Lista de Tarefas"))
        self.lblTask.setText(_translate("MainWindow", "##"))
        self.lblTaskPen.setText(_translate("MainWindow", "##"))
        self.lblTaskCom.setText(_translate("MainWindow", "##"))
